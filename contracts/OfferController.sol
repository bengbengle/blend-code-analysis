...
abstract contract OfferController is IOfferController, Signatures, Ownable2StepUpgradeable {
    ...
    /**
     * @notice 断言报价有效性
     * @param offerHash Offer hash  (see `getOfferHash`) 报价哈希
     * @param signer Address of offer signer    报价签名者地址
     * @param oracle Address of oracle contract  报价合约地址
     * @param signature Packed signature array   报价签名
     * @param expirationTime Offer expiration time 报价过期时间
